...
<html>
	<head>
		<meta charset="UTF-8">
		<title>公司新闻-<?php echo ($cninfo["name"]); ?></title>
...
<div class="main">
    <div class="box">
        ...
        <div class="tab">
            <div class="bigtitle "><a href="<?php echo U('Home/Index/news');?>">文章导航</a></div>
            <div class="malltitle"><a href="<?php echo U('Home/Index/industryNews');?>" >行业新闻</a></div>
            <div class="malltitle"><a href="<?php echo U('Home/Index/companyNews');?>" >公司动态</a></div>
