	...
	<body>
		<div class="admin-main">
			<fieldset class="layui-elem-field">
				...
				<div class="layui-field-box layui-form">
					<table class="layui-table admin-table">
						...
						<tbody id="content">
							<?php if(is_array($fileData)): foreach($fileData as $key=>$vo): ?><tr>
									<td><?php echo ($vo["name"]); ?></td>
									<td><img src="/ruopusuye/Public/Uploads/<?php echo ($vo["urlimg"]); ?>" style="width: 300px;"></td>
									<td>
										<a href="<?php echo U('Admin/Index/exitImg',array('id'=>$vo['id']));?>" class="layui-btn layui-btn-danger layui-btn-mini">更换</a>  
									</td>
			...
			<form class="layui-form" action="<?php echo U('Admin/Index/exitTechnology');?>" enctype="multipart/form-data" method="post">
				<input type="hidden" name="id" value="<?php echo ($conData["id"]); ?>">
